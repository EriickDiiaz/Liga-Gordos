...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fa-solid fa-user me-2"></i>Jugadores</h1>
        @can('Crear Equipos')
        <a href="{{ route('jugador.create') }}" class="btn btn-outline-success">
            <i class="fas fa-plus me-2"></i>Crear Nuevo Jugador
        </a>
        @endcan
    </div>
